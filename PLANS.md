...
## HR-006 — بازطراحی تجربه منابع انسانی — 2026-09-08

- [x] یکدست‌سازی نمای کلی، فیلترها، جدول‌ها، فرم‌ها، پرونده، تقویم و اعلان با تم روبی و حفظ ۱۴ سکشن موجود.
- [x] تفکیک بارگذاری صفحه‌های جزئی و گزارش‌ها، حفظ جریان‌های داده و خروجی، اعتبارسنجی دسکتاپ/موبایل و حالت تیره.
- [x] lint، typecheck، ۸۵ تست HR و Production Build؛ تحویل Branch برای Review بدون Merge.
- محیط بررسی HR-006 پس از تحویل مجاز پورت‌های مشترک به Task «PC-B Uniting»، روی ۳۱۸۸/۴۱۸۸ جدا شده است. جزئیات: `docs/tasks/HR-006.md`.
