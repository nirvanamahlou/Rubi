...
## RESERVATION-PASSENGER-IDENTITY-EDIT-0916 — PC-A — READY_FOR_REVIEW

- درخواست مالک در 2026-09-16: اصلاح شماره و تاریخ پاسپورت و سایر مشخصات هویتی مسافر از رزواسیون، برای تصحیح خطای پروندهٔ فروش.
- Branch مستقل codex/pc-a-reservation-passenger-identity-edit-0916 از origin/develop@10851d1a؛ COMPUTER_ID=PC-A.
- محدوده رزرو: endpoint عمومی رزواسیون که از CustomerService استفاده می‌کند، جدول اسامی مسافران، تست‌های API/UI و اسناد همین واحد. بدون Migration، تغییر مستقیم جدول Customers، تغییر snapshot قرارداد، دادهٔ عملیاتی یا Runtime مشترک.
- نتیجه: نام، نام لاتین پاسپورت، جنسیت، تاریخ تولد، کد ملی، شماره و تاریخ انقضای پاسپورت، کشور صدور، ملیت و کشور تولد در پروندهٔ اصلی فروش قابل اصلاح‌اند. دادهٔ حساس فقط با مجوز مناسب نمایش و ویرایش می‌شود؛ نسخهٔ قرارداد و مدارک گذشته بازنویسی نمی‌شوند.
