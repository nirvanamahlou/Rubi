...
| MASTER-003C-FINANCIAL           | PC-B         | `codex/pc-b-master-data-financial`          | مالی و پولی در Master Data: Currency، Rate Workflow/History، Bank/Branch و Payment Method مرجع       | `READY_FOR_REVIEW` | Base پشته‌ای `codex/pc-b-master-data-next`؛ بدون Query مستقیم Finance        |
...
- Branch مستقل `codex/pc-b-master-data-financial` از
  ...
  Branch جغرافیا باشد؛ Parentهای #28 و #25 پیش از این PR Merge می‌شوند.
