...
آخرین به‌روزرسانی: 2026-08-29 — MASTER-003I-SALES-REFERENCES آماده Review شد
...
| MASTER-003I-SALES-REFERENCES    | PC-B         | `codex/pc-b-master-data-sales-references`   | Vertical Slice مراجع فروش: Acquaintance، Lead Source، Channel، Lost Reason، Customer Type، Tag، Campaign | `READY_FOR_REVIEW` | Stacked روی PR #35؛ سه قفل MASTER-003 فعال و بدون Query مستقیم Customers    |
