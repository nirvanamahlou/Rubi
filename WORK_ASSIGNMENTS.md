...
- این مجوز محدودیت PR فعلی را تغییر نمی‌دهد: `codex/pc-b-system-management` و PR #304 همچنان فقط مرکز نمایشی/UI و اتصال به APIهای عمومی موجود را تحویل می‌دهند؛ Backendهای مجازشده باید جداگانه پیاده‌سازی و بازبینی شوند.
