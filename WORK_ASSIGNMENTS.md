...
- تحویل: انتخاب قالب فعال در فرم انتشار بلیط Tour Workspace، snapshot روی بلیط منتشرشده، خروجی بر اساس قالب انتخابی یا Excel ساده، دو فایل ازمیر/اسپارتا پاک‌سازی‌شده در اطلاعات پایه و غیرفعال‌سازی قالب متصل به بلیط. Migration افزایشی آماده است و هنوز روی DB عملیاتی اعمال نشده. PR مستقل به develop پس از Push ایجاد می‌شود.
