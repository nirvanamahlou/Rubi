...
- نتیجه: متن و آیکن هر دو CTA آبی در کارت‌های نمای کلی و نمای فیلترشده با `text-white` و `hover:text-white` تثبیت شدند. کنتراست سفید روی آبی اصلی `6.80:1` و مطابق WCAG AA است؛ ۵ تست قراردادی Documents، Web lint/typecheck و Production Build با ۴۰ Route موفق‌اند. رزرو پیاده‌سازی آزاد و Branch برای Review آماده است؛ Merge و جایگزینی Runtime انجام نشده‌اند.
