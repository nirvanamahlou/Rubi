...
- نتیجه مجاز تحویل شد: دو بخش داخلی یک ماژول، درخت حساب، کنترل‌های دوره/Posting، قراردادهای
...
- پیگیری صریح مالک در 2026-09-12: حسابداری و کارتابل دیگر دو ماژول/فضای مستقل دیده
  نمی‌شوند. مسیر یگانه `/finance` با عنوان «مالی و کارتابل درخواست‌ها» در گروه «مالی»
  قرار می‌گیرد و حسابداری/خزانه و کارتابل فقط دو بخش داخلی همان ماژول‌اند. محدوده این
  پیگیری به metadata ناوبری، route، Web مالی و تست‌های مربوط محدود است.
  ۲۷ تست هدفمند Web، lint محدود، typecheck و Build نهایی ۴۰ مسیر موفق‌اند.
