...
| MASTER-003H-TRANSPORT           | PC-B         | `codex/pc-b-master-data-transport`          | Vertical Slice حمل‌ونقل: Airline، Aircraft، Cabin، Baggage، Manifest، Rail و Bus با پروفایل Popup       | `READY_FOR_REVIEW` | Stacked روی PR #33؛ سه قفل MASTER-003 فعال و Customers دست‌نخورده است       |
