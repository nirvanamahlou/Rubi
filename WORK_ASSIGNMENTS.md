...
- نتیجه: تب و دکمهٔ بازگشتِ تکراری حذف شدند؛ کارت‌های نمای کلی و ویرایش واقعی تنظیمات باقی ماندند و هنگام بازبودن یک کارت، «نمای کلی» فعال می‌ماند. تست اختصاصی، ESLint، typecheck و build تولیدی Web موفق‌اند. تست قراردادی قدیمیِ `/system` برای لینک‌های IAM/Legal Entity از پیش با source حاضر ناسازگار است و تغییری در آن داده نشد.
