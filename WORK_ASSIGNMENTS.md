...
آخرین به‌روزرسانی: 2026-08-29 — MASTER-003H-TRANSPORT برای PC-B رزرو شد
...
| MASTER-003H-TRANSPORT           | PC-B         | `codex/pc-b-master-data-transport`          | Vertical Slice حمل‌ونقل: Airline، Aircraft، Cabin، Baggage، Manifest، Rail و Bus با پروفایل Popup       | `IN_PROGRESS`      | روی PR #33؛ زیر سه قفل فعال PC-B/MASTER-003 و بدون تغییر Customers          |
