...
- Follow-up بعدی مالک: کنترل فروش روی همه کارت‌ها نمایش داده می‌شود؛ فعال‌ها «توقف فروش»، متوقف‌ها و پیش‌نویس‌ها «فعال‌کردن فروش» و لغوشده‌ها وضعیت غیرفعال «فروش متوقف است» دارند. ویرایش برای همه وضعیت‌های بلیت در دسترس است؛ کنترل نسخه، اعتبار داده، ظرفیت و محافظت تغییرات دارای تخصیص حفظ شده‌اند.
