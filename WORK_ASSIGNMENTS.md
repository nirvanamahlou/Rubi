...
- نتیجه: اولین قراردادِ نتیجهٔ فعلی به‌طور خودکار انتخاب می‌شود و با فیلتر یا تغییر نتایج، پنل فقط همان قراردادِ معتبر را هدف می‌گیرد. پنل زیر جدول در دسکتاپ چهار بلوک افقی دارد: قرارداد انتخاب‌شده و سه گروه دکمه، با دکمه‌های دو ستونه و کم‌ارتفاع.
