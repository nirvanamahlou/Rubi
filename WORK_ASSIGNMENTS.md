...
آخرین به‌روزرسانی: 2026-08-26 — فرم‌های Master Data وسط‌صفحه شدند و سازمان هتل حذف شد؛ قفل‌های MASTER-003 حفظ شدند
...
| MASTER-003                      | PC-B         | `codex/pc-b-master-data-advanced`           | توسعه افزایشی Master Data: Schema/Migration، Contract، Backend، Frontend، Excel Import و Test | `IN_PROGRESS`      | Draft PR #25؛ کد داخلی خودکار شد؛ سه قفل فعال و Dependency lock آزاد است    |
