...
## RESERVATION-FORM-CHILD-BAND-DISPLAY-0916 — PC-A — READY_FOR_REVIEW

- درخواست مالک در 2026-09-16: ردهٔ کودک هتل (۲ تا ۶ یا ۶ تا ۱۲ سال) در پیش‌نمایش فرم رزواسیون نیز مانند PDF ارسالی کارگزار نمایش داده شود.
- Branch مستقل `codex/pc-a-reservation-form-child-band-display-0916` از `origin/develop@10851d1a`؛ `COMPUTER_ID=PC-A`.
- محدوده رزرو: projection فرم رزواسیون، جدول مسافران پیش‌نمایش، تست‌های همان فرم و اسناد این واحد. بدون Migration، API contract، دادهٔ عملیاتی، Permission یا Runtime مشترک.
- نتیجه: ردهٔ کودک برای کارگزار در همان ستون AGE RATE فرم رزواسیون و واچر نمایش داده می‌شود: CHD (2-6) یا CHD (6-12). برای ADL و INF هیچ پسوندی چاپ نمی‌شود؛ ساختار جدول و ستون‌ها تغییر نکرد.
