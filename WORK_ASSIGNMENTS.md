...
- درخواست مالک محصول در 2026-09-14: آخرین چیدمان و عملکرد ثبت‌شدهٔ پنل عملیات قرارداد در رزرواسیون از تاریخچه بازیابی شود. Branch مستقل `codex/pc-a-reservation-action-panel-recovery-0914` پس از بررسی overlap روی `origin/develop@19264e2a` یکپارچه شد و Worktree مستقل `reservation-action-panel-recovery-0914` استفاده می‌شود.
