...
| MASTER-003E-SUPPLIERS           | PC-B         | `codex/pc-b-master-data-suppliers`          | Vertical Slice سازمان‌ها و تأمین‌کنندگان: Supplier، Broker، Contact ماسک‌شده، Service و Collaboration | `IN_PROGRESS`      | Stacked روی PR #30؛ قفل‌های Migration/Contract/Docs فعال MASTER-003 با PC-B |
