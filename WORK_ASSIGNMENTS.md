...
| LEGAL-ENTITY-CONTEXT-001        | PC-A         | `codex/pc-a-legal-entity-context`           | Legal Entity Full-Stack، Prisma، API، Contract، App Shell، صفحه مدیریت، Audit و Test          | `READY_FOR_REVIEW` | PR #24؛ Base `0ba85d4`؛ Gateها سبز؛ قفل‌ها تا Merge/Handoff فعال‌اند        |
