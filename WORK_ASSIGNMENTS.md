...
- نتیجه: خروجی جدولی قدیمی از پیش‌نمایش/چاپ حذف و با فرم برنددار PDF یکسان شد؛ MR/MRS/CHD/INF، کارت‌های مسیر، سایه شهرها، ساعت حرکت/رسیدن و هشدار فارسی/انگلیسی حفظ شدند. ۱۸ تست هدفمند، lint، typecheck و build تولیدی Web با ۵۰ route موفق‌اند. PDF ساختگی رفت‌وبرگشت روی یک صفحه A4 با Chrome/Poppler رندر و بصری بررسی شد.
