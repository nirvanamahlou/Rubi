## 2026-09-21 — SALES-TICKET-CARD-DATE-FOCUS-0921 — PC-A — READY_FOR_REVIEW

- درخواست مالک: در کارت انتخاب بلیت قرارداد جدید، ساعت حرکت و رسیدن کم‌اهمیت‌تر و در دو لبهٔ راست و چپ قرار گیرند و تاریخ همراه ایرلاین برجسته‌تر نمایش داده شود.
- شاخه مستقل `codex/pc-a-sales-ticket-card-date-focus-0921` از `origin/develop@e3d22d75`. محدوده فقط کارت بلیت Sales، تست متمرکز و ثبت وضعیت همین واحد است؛ API، Schema/Migration، Permission، داده، Dependency/Lockfile و سایر فرم‌ها تغییر نمی‌کنند.
- نتیجه: تاریخ حرکت و، در پرواز شبانه، تاریخ رسیدن در سربرگ کنار ایرلاین با اندازه و وزن بیشتر نمایش داده می‌شوند؛ ساعت‌ها کوچک‌تر در دو لبهٔ مسیر و مدت پرواز در میانه قرار گرفتند. ۸ تست کارت، lint متمرکز، typecheck و build تولیدی Web با ۵۰ route موفق‌اند.
