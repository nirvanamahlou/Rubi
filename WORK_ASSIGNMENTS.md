...
آخرین به‌روزرسانی: 2026-08-29 — MASTER-003G-UX-CONSOLIDATION آغاز شد
...
| MASTER-003G-UX-CONSOLIDATION    | PC-B         | `codex/pc-b-master-data-ux-consolidation`   | ادغام نرخ/تاریخچه در ارز، ادغام نمای شهر/استان، پروفایل‌های Popup و حذف نمای مستقل مخاطبان             | `IN_PROGRESS`      | Stacked روی MASTER-003F؛ فقط Web/Test/Docs و بدون Schema، Migration یا API  |
