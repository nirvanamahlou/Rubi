...
## 2026-09-22 — MASTER-DATA-QA-REMEDIATION-0922 — PC-B — ACTIVE

- درخواست مالک: ایرادهای قطعی گزارش QA عملی سکشن اطلاعات پایه رفع و همان سناریوها دوباره اجرا شوند.
- شاخه مستقل `codex/pc-b-masterdata-qa-remediation-0922` از `origin/develop@d072f631`؛ `COMPUTER_ID=PC-B`.
