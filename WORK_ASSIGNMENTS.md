...
- Follow-up بعدی مالک: بلیت متوقف‌شده از همان کارت دوباره فعال می‌شود و ویرایش برای همه وضعیت‌های بلیت در دسترس است؛ کنترل نسخه، اعتبار داده، ظرفیت و محافظت تغییرات دارای تخصیص حفظ شده‌اند.
