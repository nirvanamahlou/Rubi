...
const seedArguments = [
  ...
  mode === '--apply' ? '--apply-realistic' : '--preview-realistic',
];
if (mode === '--apply')
  seedArguments.push('--acknowledge-local-synthetic-data');
...
if (seed.status !== 0)
  throw new Error(`Master Data demo command failed with ${seed.status}.`);
