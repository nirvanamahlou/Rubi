...
window.PackageCards=(()=>{
 ...
 const geometry={
  ...
  'malaysia-kuala':{band:[216,1200,787,98],panel:[213,278,790,911],gap:8,rowGap:9,radius:15,color:'#478aff',tableColor:'#c2d1e9'},
  'malaysia-penang':{band:[216,1126,787,115],panel:[213,277,790,826],gap:8,rowGap:9,radius:15,color:'#478aff',tableColor:'#c2d1e9'},
  'malaysia-singapore':{band:[238,1033,864,107],panel:[238,263,864,760],gap:7,rowGap:9,radius:15,color:'#478aff',tableColor:'#c2d1e9'},
  'malaysia-langkawi':{band:[200,1131,802,111],panel:[203,278,803,842],gap:7,rowGap:9,radius:14,color:'#478aff',tableColor:'#c2d1e9'},
