...
> = {
  ...
  groups: {
    singular: 'گروه کارکنان',
    plural: 'گروه‌های کارکنان',
    fields: [
      { key: 'id', label: 'کد گروه', required: true, type: 'text', placeholder: 'مانند GROUP-03' },
      { key: 'title', label: 'نام گروه', required: true, type: 'text' },
      {
        key: 'groupType',
        label: 'نوع گروه',
        required: true,
        type: 'select',
        options: ['سازمانی', 'نوع همکاری', 'مهارتی'],
      },
      { key: 'description', label: 'شرح و معیار عضویت', required: true, type: 'textarea', full: true },
      { key: 'effectiveFrom', label: 'تاریخ اثر', required: true, type: 'date' },
      { key: 'status', label: 'وضعیت', required: true, type: 'select', options: statusOptions },
    ],
    columns: [
      { key: 'id', label: 'کد گروه' },
      { key: 'title', label: 'نام گروه' },
      { key: 'groupType', label: 'نوع گروه' },
      { key: 'description', label: 'معیار عضویت' },
      { key: 'effectiveFrom', label: 'تاریخ اثر' },
      { key: 'status', label: 'وضعیت' },
    ],
  },
