...
export const marketingSectionTabs = {
  ...
  communications: [
    ...
    ['history', 'تاریخچه ارسال‌ها', 'وضعیت تحویل و نتیجه ارسال‌های قبلی'],
    ['templates', 'قالب‌های پیام', 'قالب‌های نسخه‌دار و قابل ویرایش'],
  ],
  content: [
...
> = {
  ...
  'communications-history': [
    ...
    'رسید تجمیعی تحویل بدون نمایش اطلاعات تماس مخاطب',
    'پایان‌یافته',
  ],
  'communications-templates': [
    'قالب معرفی مسیر فرهنگی',
    'نسخه سوم با جای‌نگهدارهای غیرشخصی',
    'تأییدشده',
  ],
  'content-library': [
