...
export const masterDataCatalog: readonly MasterDataCatalogItem[] = [
  ...
  },
  {
    ...
    group: 'حمل‌ونقل',
    description: 'ایرلاین‌ها و قواعد بار مرجع.',
    fields: [
      {
        key: 'airlineCodes',
        label: 'کد ایرلاین',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'زبان‌ها',
        type: 'text',
        placeholder: 'فارسی، انگلیسی، ترکی',
        required: true,
      },
      {
        key: 'expertise',
      ...
      },
      {
        ...
        type: 'text',
        placeholder: '+98912...',
        hint: 'رمزنگاری می‌شود و در فهرست فقط مقدار ماسک‌شده نمایش داده می‌شود.',
      },
      {
        key: 'roamingPhone',
        label: 'تلفن رومینگ',
        type: 'text',
        placeholder: '+90...',
        hint: 'رمزنگاری می‌شود و مقدار کامل در Audit ثبت نمی‌شود.',
      },
      {
        key: 'welcomeSignCode',
        label: 'کد تابلو استقبال',
        type: 'text',
        placeholder: 'NS-IST-24',
      },
      {
        key: 'operationalNotes',
        label: 'توضیحات اجرایی',
        type: 'text',
        placeholder: 'توضیح مرجع غیرحساس',
      },
    ],
    preview: {
      code: 'LEADER_SAMPLE',
      name: 'لیدر نمونه',
      englishName: 'Sample Leader',
      cityId: 'city_sample',
  ...
  },
  {
    key: 'tour-types',
    label: 'نوع تور',
    singularLabel: 'نوع تور',
    group: 'خدمات سفر',
    description:
      'کاتالوگ مرجع نوع تور؛ برنامه، ظرفیت، محصول و قیمت در ماژول مالک نگهداری می‌شود.',
    fields: [
      nameField,
      {
        key: 'englishName',
  ...
  },
  {
    key: 'transfer-types',
    label: 'نوع ترانسفر',
    singularLabel: 'نوع ترانسفر',
    group: 'خدمات سفر',
    description:
      'مرجع نوع وسیله و مدل سرویس؛ رزرو، راننده، ناوگان عملیاتی و قیمت خارج از Master Data است.',
    fields: [
      nameField,
      {
        key: 'englishName',
  ...
  },
  {
    key: 'cip-services',
    label: 'خدمات CIP',
    singularLabel: 'خدمت CIP',
    group: 'خدمات سفر',
    description:
      'خدمت تشریفات مرجع با اتصال به فرودگاه و Provider؛ ظرفیت، رزرو و Voucher خارج از این Aggregate است.',
    fields: [
      nameField,
      {
        key: 'englishName',
        label: 'عنوان انگلیسی',
        type: 'text',
        placeholder: 'Airport CIP Arrival',
      },
      {
        key: 'airportId',
        label: 'فرودگاه',
        type: 'text',
        placeholder: 'فرودگاه را انتخاب کنید',
        required: true,
      },
      {
        key: 'supplierId',
      ...
      {
        key: 'includedItems',
        label: 'اقلام شامل‌شده',
        type: 'text',
        placeholder: 'استقبال، Fast Track، سالن',
        required: true,
      },
      {
        key: 'description',
    ...
    preview: {
      name: 'CIP ورودی',
      airportId: 'airport_sample',
      passengerScope: 'ALL',
      includedItems: 'استقبال,سالن',
      displayOrder: '0',
    },
  },
  {
    key: 'visa-services',
    label: 'خدمات ویزا',
    singularLabel: 'خدمت ویزا',
    group: 'خدمات سفر',
    description:
      'تعریف مرجع خدمت ویزا؛ پرونده، اسناد مسافر، پرداخت و پیگیری در ماژول مالک می‌ماند.',
    fields: [
      nameField,
      {
        key: 'englishName',
      ...
      },
      {
        ...
        label: 'شرح',
        type: 'text',
        placeholder: 'راهنمای عمومی خدمت',
      },
      {
        key: 'displayOrder',
        label: 'ترتیب نمایش',
