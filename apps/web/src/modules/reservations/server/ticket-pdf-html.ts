...
<td>${escapeHtml(offer.contractOnly ? 'PENDING RESERVATION' : 'DRAFT')}</td>
<td>—</td>
</tr>`,
        )
        .join('');
...
<p class="draft">DRAFT - NOT VALID FOR TRAVEL / پیش‌نمایش، فاقد اعتبار سفر</p>
...
<section class="notice"><h3><b>2</b> NOTICE</h3><p>All times are shown in Tehran time. This preview is not an issued ticket. Reservation confirmation, ticket number, airport codes and baggage must come from the issuing system.</p><p dir="rtl">اطلاعات صدور در این پیش‌نمایش تأیید نشده‌اند.</p></section>
<footer>حضور در فرودگاه ۳ ساعت قبل از پرواز الزامی است.<br><strong>PRESENCE 03:00 BEFORE FLIGHT TIME AT THE AIRPORT IS MANDATORY</strong></footer>
</article>`;
    })
    .join('');
  return `<!doctype html><html><head><meta charset="utf-8"><style>
@page{size:A4 portrait;margin:0}*{box-sizing:border-box}html,body{margin:0;background:#fff;color:#07164b;font-family:Arial,ReservationNazanin,sans-serif}.ticket{width:210mm;min-height:297mm;padding:12mm 10mm;border:1.5mm solid #07164b;border-top:4mm solid #173d7a;border-bottom:5mm solid #07164b;page-break-after:always}.ticket:last-child{page-break-after:auto}header{display:flex;align-items:center;justify-content:space-between;gap:8mm}h1{font-size:28pt;margin:0}header i{display:block;width:38mm;height:1mm;margin-top:4mm;background:#173d7a}header img{width:50mm;height:28mm;object-fit:contain}.draft{text-align:center;border:1px dashed #b91c1c;color:#b91c1c;padding:2mm;font-size:9pt}h2{text-align:center;font-size:18pt;margin:6mm 0}.identity{display:grid;grid-template-columns:repeat(3,1fr);gap:5mm;font-size:9pt}.identity strong{display:block;margin-top:1.5mm;color:#111827}.transfer{font-size:9pt}.flight,.notice{position:relative;border:1px solid #07164b;border-radius:3mm;margin-top:10mm;padding:7mm 3mm 3mm}.flight h3,.notice h3{position:absolute;left:-1px;top:-7mm;margin:0;padding:2mm 5mm 2mm 0;border-radius:2mm 5mm 5mm 0;background:#07164b;color:#fff;font-size:9pt}.flight h3 b,.notice h3 b{padding:2.2mm 3mm;margin-right:2mm;border-radius:2mm 0 3mm 0;background:#173d7a}table{width:100%;border-collapse:collapse;font-size:7.5pt}th{padding:2.5mm 1mm;background:#173d7a;color:#fff}td{padding:2.5mm 1mm;text-align:center;border:1px dashed #c4c8cd;color:#111827}.notice p{font-size:8.5pt;line-height:1.5;margin:2mm}footer{text-align:center;margin-top:8mm;font-size:8.5pt;line-height:1.8}
