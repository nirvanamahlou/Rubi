...
Ticket Catalog هنگام انتشار بلیط، شناسهٔ قالب فعال را از API عمومی Master Data اعتبارسنجی و نام/نسخه/مرجع فایل را روی همان بلیط ثابت می‌کند. Reservations این انتخاب را از API عمومی Ticket Catalog می‌خواند؛ غیرفعال شدن بعدی قالب، خروجی بلیط‌های قبلی را عوض نمی‌کند. نبود قالب به خروجی سادهٔ XLSX می‌انجامد.
