...
برای برنامه `REPORTING-P0`، مالک پروژه اجرای محدود P0-04 و ادامه‌های صریحاً رزروشده را
به `PC-C` تفویض کرده است. این تفویض مالکیت دائمی بالا را جابه‌جا نمی‌کند: فایل‌های
Reporting فقط در Work Item مستقل PC-C و تغییر قرارداد مشترک فقط با هماهنگی PC-A/PC-B
مجاز است. جزئیات در
