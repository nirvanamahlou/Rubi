...
زنجیره قابل‌ردیابی باشند. Nora یک CRM جدا از عملیات سفر نیست؛ هویت مشتری، Sales
...
- کارشناس خدمات مشتری، مارکتینگ، منابع انسانی و مدیر سیستم
...
مرخصی/ماموریت، اضافه‌کاری، ارزیابی، آموزش، تجهیزات و ورودی کنترل‌شده پرداخت حقوق است.

## خارج از محدوده

حسابداری قانونی کامل، مالیات رسمی، حقوق و دستمزد قانونی و کامل، عملیات پرواز و
خدمه، تعمیر و نگهداری، کنترل واقعی صندلی ایرلاین، GDS و DCS. Nora با این سامانه‌ها
از طریق API یا Export یکپارچه می‌شود و نقش یا شماره رسمی آن‌ها را جعل نمی‌کند.
