...
چهار تب شعب، نمایندگان، امضاداران و مدیر حساب مطابق Screenshot535 از نوار بالای پرونده سازمان حذف شدند. تب مشخصات و نقش‌ها و بخش‌های داخلی همان صفحه حفظ شده‌اند؛ تغییری در داده/API وجود ندارد. بررسی مرورگر تأیید شد؛ وضعیت build و runtime در WORK_ASSIGNMENTS ثبت می‌شود.
