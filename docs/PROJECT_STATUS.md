...
جزئیات در [PROCUREMENT-001](tasks/PROCUREMENT-001.md) است. کنترل‌های تقویم خرید و تأمین با الگوی مرجع روبی همسان شد: گرید ۳×۴ ماه و سال شمسی، گرید روز با روزهای مجاور کم‌رنگ، تب میلادی با برچسب‌های انگلیسی و فیلترهای «از تاریخ» و «تا تاریخ». مقدار تاریخ انتخاب‌شده اکنون در همان فیلتر نمایش داده می‌شود و پاک‌کردن، هر دو کنترل را به حالت اولیه برمی‌گرداند. کلیک روی فضای بیرون تقویم نیز آن را می‌بندد، درحالی‌که تعامل‌های داخل تقویم فعال می‌مانند. در نوار فیلتر فهرست درخواست‌ها، عنوان‌های «جست‌وجو»، «وضعیت درخواست» و «واحد درخواست‌کننده» نمایش داده می‌شوند و انتخاب‌گر داخلی حالت نمایشی حذف شده است.
