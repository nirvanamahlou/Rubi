...
تعریف مستقل Tahoma از پوشش مشترک آژانس‌ها حذف شد تا فهرست، پرونده و پاپ‌آپ‌ها فونت سراسری وزیرمتن روبی را به ارث ببرند. اندازه و چیدمان قبلی حفظ است؛ بدون تغییر فونت سراسری، وابستگی، API یا داده. Build تولیدی ۴۰ مسیر و ۸۷ آزمون سازمان‌ها موفق‌اند؛ بررسی نهایی فونت محاسبه‌شده مرورگر پس از راه‌اندازی Web3100 در گزارش Task ثبت می‌شود.
