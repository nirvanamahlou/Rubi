...
- شمارنده‌های بزرگسال، کودک و نوزاد در فروش و تعداد اتاق، یک‌تخته، دوتخته و تخت اضافه با انتخاب‌گرهای جمع‌وجور ارائه می‌شوند. تعداد مسافر پیش از انتخاب بلیت تعیین می‌شود و نوزاد صندلی مصرف نمی‌کند؛ کنترل ظرفیت اتمیک قبلی حفظ شده است.
