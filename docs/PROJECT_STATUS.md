...
## قیمت‌گذاری فروش و خرید هتل — 2026-09-06 — آماده کد، فعال‌سازی متوقف
...
- تغییر تاریخ داخل رزرواسیون هنوز BLOCKED است: صف موجود فقط snapshot ورودی immutable دارد؛ API و مدل نسخه‌دار اصلاح اقامت موجود نیست و Prisma تغییر محلی خارج از فروش دارد. هیچ ذخیره‌سازی نمایشی یا تغییر snapshot اجرا نشد. قفل‌ها آزاد نمی‌شوند.
