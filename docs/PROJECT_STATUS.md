...
- فرم پیکربندی Reports فقط XLSX می‌فرستد. workbook در سطر اول نام گزارش و زمان تولید UTC، در دو سطر بعدی عنوان/مقدار فیلترهای snapshot و از سطر چهارم جدول داده را نشان می‌دهد؛ کد گزارش و Projection از محتوای workbook حذف شدند.
