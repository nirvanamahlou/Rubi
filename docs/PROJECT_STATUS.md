...
- کارت بلیت اکنون برای وضعیت متوقف‌شده اقدام «فعال‌کردن فروش» دارد و ویرایش در پیش‌نویس، فعال، متوقف و لغوشده قابل انجام است؛ وضعیت خود بلیت هنگام ویرایش حفظ می‌شود و بلیت لغوشده همچنان مستقیماً قابل فعال‌سازی نیست.
