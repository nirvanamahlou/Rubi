...
## DOCUMENTS-003C — بسته داده نمایشی قابل اجرای اسناد — آماده بررسی

- `PC-B` روی `codex/pc-b-documents-demo-bootstrap` یک بسته صریح و محلی برای ساخت هفت
  سند نمونه آماده کرد. Git فقط تعریف‌های ساختگی و مولد تصویر را نگه می‌دارد؛ هر دستگاه
