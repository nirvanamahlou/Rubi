...
به درخواست مالک، کارت «عملیات فروش» و مسیرهای داخلی مسافران سازمانی، قراردادهای فروش و سفارش‌ها از پرونده مشترک آژانس و مشتری سازمانی حذف شد. شش بخش دیگر پرونده حفظ است. تغییر فقط در نمایش پرونده است؛ بدون تغییر API، داده، مجوز یا Migration. بررسی و انتشار اجرای محلی در جریان است؛ جزئیات: [گزارش حذف بخش فروش](tasks/B2B-DOSSIER-SALES-REMOVAL-001.md).
