## 2026-09-16 — RESERVATION-FORM-CHILD-REDESIGN-0916 — PC-A — READY_FOR_REVIEW

ردهٔ بلیط در فرم رزواسیون همچنان `CHD` می‌ماند، اما هنگام ساخت فرم ارسالی کارگزار و واچر، بازهٔ ثبت‌شدهٔ هتل کنار آن در همان سلول چاپ می‌شود: `CHD (2-6)` یا `CHD (6-12)`. شمارش کودک در خلاصه فرم با این متن نمایشی سازگار باقی می‌ماند و ستون تازه‌ای به جدول مسافران افزوده نشد.

پنجرهٔ ویرایش قرارداد بازطراحی شد: سربرگ شماره قرارداد و نسخهٔ عملیاتی را روشن نشان می‌دهد، تب‌های شماره‌دار بخش فعال را مشخص می‌کنند و فرم هر بخش هدر و گروه‌بندی خواناتر دارد. انتخاب‌گرهای خام ردهٔ بلیط، ردهٔ کودک هتل و جنسیت با کنترل مشترک، برچسب کامل و حالت انتخاب‌نشده جایگزین شدند. ۵ تست هدفمند مدل فرم/واچر، lint فایل‌های تغییرکرده، typecheck کامل Web و build تولیدی Web موفق‌اند. Migration، Seed، دادهٔ عملیاتی، API، Dependency/Lockfile و Runtime مشترک تغییر نکردند. Branch: `codex/pc-a-reservation-form-child-redesign-0916`.
