## 2026-09-21 — SALES-TICKET-CARD-DATE-FOCUS-0921 — READY_FOR_REVIEW

کارت بلیت قرارداد جدید بازطراحی شد: تاریخ حرکت و تاریخ رسیدنِ روز متفاوت در سربرگ کنار ایرلاین برجسته‌اند؛ ساعت حرکت و رسیدن با وزن بصری کمتر در دو لبه و مدت پرواز در میانه دیده می‌شوند. ۸ تست کارت، lint، typecheck و build تولیدی Web با ۵۰ route موفق‌اند. منطق انتخاب، ظرفیت، نرخ فروش تکی و منطقهٔ زمانی تهران ثابت مانده است.
