...
- فرم درخواست خرید اکنون شعبهٔ کارمند جاری را از projection عمومی HR و، در نبود اتصال حساب کاربری به پروندهٔ کارمند، اولین شعبهٔ مجاز را به‌صورت پیش‌فرض انتخاب می‌کند؛ در نتیجه فهرست کارکنان فعال و واحدهای سازمانی ثبت‌شده در HR بدون انتخاب دستی اولیه بارگذاری می‌شوند.
...
- اعتبارسنجی: ۳۴ تست هدفمند Web، ۸ تست هدفمند API، lint و typecheck برنامه‌های Web/API موفق‌اند.
