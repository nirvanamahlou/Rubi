...
## 2026-09-15 — MANIFEST-TEMPLATE-PER-TICKET-0915 — PC-A — READY_FOR_REVIEW

انتخاب قالب MANIFEST در انتشار هر بلیط به‌صورت اختیاری ثبت و نام، نسخه و مرجع فایل آن در بلیط ثابت می‌شود. خروجی رزرواسیون برای بلیط‌های بدون قالب، فایل ساده می‌سازد و برای بلیط‌های قالب‌دار از فایل نسخهٔ انتخاب‌شده استفاده می‌کند. دو فایل نمونهٔ ازمیر و اسپارتا بدون دادهٔ مسافر و ماکرو در فرم اطلاعات پایه قابل انتخاب‌اند؛ انتشار رکورد قالب پس از بررسی ایرلاین و مقصد انجام می‌شود. FK و Migration افزایشی فقط برای بلیط‌های جدید است. ۲۵ تست مستقیم، typecheck و build کامل ۴۶مسیره موفق‌اند؛ گزارش در [MANIFEST-TEMPLATE-PER-TICKET-0915](tasks/MANIFEST-TEMPLATE-PER-TICKET-0915.md) ثبت شده است.
