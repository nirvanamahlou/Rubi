...
## DOCUMENTS-003F — انتخاب پرونده جست‌وجویی در بارگذاری سند — آماده بررسی

- `PC-B` روی Branch مستقل `codex/pc-b-documents-record-picker` چهار ورودی فنی ارتباط سند را با یک Dropdown جست‌وجویی «پرونده مربوطه» جایگزین کرد. کاربر اکنون نام پرونده را می‌بیند و دیگر ماژول، نوع رکورد یا شناسه مبدأ را دستی وارد نمی‌کند.
