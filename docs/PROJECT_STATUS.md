...
## CA-REMOVE-REPORT-INTRO

عنوان «گزارش امور مشتریان» و زیرعنوان معرفی از بالای گزارش حذف شد؛ زمان دریافت، کارت‌ها و داده‌ها حفظ شده‌اند. تغییر فقط در فرانت‌اند با الگوی قبلی روبی است.
