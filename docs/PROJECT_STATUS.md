...
- همه کارت‌ها کنترل وضعیت فروش دارند: فعال‌ها «توقف فروش»، متوقف‌ها و پیش‌نویس‌ها «فعال‌کردن فروش» و لغوشده‌ها «فروش متوقف است» غیرفعال نشان می‌دهند. ویرایش در پیش‌نویس، فعال، متوقف و لغوشده قابل انجام است؛ وضعیت خود بلیت هنگام ویرایش حفظ می‌شود و بلیت لغوشده همچنان مستقیماً قابل فعال‌سازی نیست.
