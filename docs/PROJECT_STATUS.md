...
## HR-002 — بازآرایی کارکرد، تجهیزات و توسعه کارکنان

PC-B روی codex/pc-b-hr-time-development: خودرو زیر تجهیزات، انتقال مأموریت، ادغام فرم آموزش/نتیجه، اهداف وزنی، تقویم شیفت مشتق‌شده و ورود/خروج XLSX ماژول‌محلی. اتصال‌های خارجی پایدار و مجوز ویژه مدیر هنوز نیازمند قرارداد عمومی و handoff هستند. جزئیات و محدودیت‌ها در docs/tasks/HR-001.md. Migration و dependency تغییر نکرد.

HR-002: بخش مستقل مدارک پرسنلی از منابع انسانی حذف شد؛ مدارک پرونده کارمند و آرشیو اسناد حفظ شدند.

HR-003: نمای کلی و گزارش PDF چندصفحه‌ای فارسی در سکشن‌های HR اضافه شد؛ انتخاب موضوع و جست‌وجو بر خروجی اعمال می‌شوند. ۶۵ تست HR موفق؛ بدون Migration و تغییر وابستگی.

HR-004: پروفایل شخصی کارکنان، خلاصه مرخصی و کسورات، فیش و درخواست‌ها به رکوردهای همان فرد محدود شدند؛ نام کارمند لینک پروفایل است. داده‌های قدیمی بدون مالک نمایش داده نمی‌شوند. ۶۹ تست موفق؛ محدودیت ذخیره نشست برقرار است.

HR-004 follow-up: نوار سه‌دکمه‌ای نمای کلی/عملیات/گزارش‌ها از بالای سکشن‌های منابع انسانی حذف شد؛ آمار و خروجی PDF در پنل جمع‌شونده پایین هر سکشن حفظ شدند.
