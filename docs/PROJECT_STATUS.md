...
ردیف دکمه‌های مشخص‌شده در Screenshot532 و کادر «ثبت اطلاعات پرونده» از نمای اصلی آژانس/مشتری سازمانی حذف شد. کارت‌های اصلی و فرم‌های هر بخش در دسترس‌اند. تغییر صرفاً نمایشی است؛ بدون تغییر داده، API یا Migration. جزئیات بررسی و اجرای محلی: [B2B-DOSSIER-SHORTCUTS-001](tasks/B2B-DOSSIER-SHORTCUTS-001.md).
