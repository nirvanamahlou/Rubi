...
طبق درخواست مالک در 2026-09-19، تصویر login-airline-b2.png بدون لایه یا حرکت جداگانهٔ هواپیما به‌عنوان پس‌زمینهٔ ثابت صفحه ورود باقی می‌ماند. NOORA با نمایان‌شدن نرم قبلی نمایش داده می‌شود؛ منطق ورود و بخش‌های دیگر تغییر نکرده‌اند.
