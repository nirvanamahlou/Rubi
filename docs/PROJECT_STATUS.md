...
## 2026-09-17 — LOGIN-NOORA-MOTION-FOLLOWUP-0917 — PC-A — IN_PROGRESS

اصلاح نهایی صفحهٔ ورود روی آخرین develop در حال انجام است: پس‌زمینه ثابت می‌ماند، فقط هواپیمای واقعی از بیرون سمت راست به چپ تا جای اصلی حرکت می‌کند و NOORA با ابر نرم از سمت چپ به‌تدریج نوشته می‌شود. منطق ورود و بخش‌های دیگر تغییری ندارند.
