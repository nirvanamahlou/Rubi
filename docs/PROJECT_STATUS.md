...
## 2026-09-16 — RESERVATION-FORM-CHILD-BAND-DISPLAY-0916 — PC-A — READY_FOR_REVIEW

پیش‌نمایش فرم رزواسیون باید ردهٔ هتل کودک را هم‌راستا با PDF ارسالی کارگزار نمایش دهد. محدوده فقط projection و جدول مسافران فرم است؛ دادهٔ قرارداد، API و Runtime مشترک تغییر نمی‌کنند.

نتیجه: ردهٔ کودک هتل در ستون AGE RATE همان ردیف مسافر، بدون افزودن ستون جدید، به شکل CHD (2-6) یا CHD (6-12) نمایش داده می‌شود. برای بزرگسال و نوزاد تغییری رخ نمی‌دهد. TypeScript و lint وب موفق‌اند؛ ۷ تست هدفمند تنظیمات فرم و PDF رزواسیون نیز موفق‌اند. Migration، API، دادهٔ عملیاتی و Runtime مشترک تغییر نکرده‌اند.
