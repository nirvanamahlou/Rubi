...
کنترل‌های سرستون نمودار روند اصلاح شدند: تقویم محور زمان و واحد پولِ همان نمودار، زیر برچسب نوع نمودار در یک ردیف فشرده، قابل‌دسترسی و wrap-safe قرار می‌گیرند. نمودارهای غیرروند همان انتخاب‌گر مستقل ارز را حفظ می‌کنند. ۱۶ تست Dashboard، lint، TypeScript و build تولیدی Web موفق‌اند؛ API و داده تغییر نکرده‌اند.
