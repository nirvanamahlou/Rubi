...
جزئیات در [PROCUREMENT-001](tasks/PROCUREMENT-001.md) است. کنترل‌های تقویم خرید و تأمین با الگوی مرجع روبی همسان شد: گرید ۳×۴ ماه و سال شمسی، گرید روز با روزهای مجاور کم‌رنگ، تب میلادی با برچسب‌های انگلیسی و فیلترهای «از تاریخ» و «تا تاریخ».
