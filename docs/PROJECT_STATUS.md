## 2026-09-23 — CUSTOMER-AFFAIRS-QA-FIXES-0923 — READY_FOR_REVIEW

مجوز گزارش و داشبورد امور مشتریان برای نقش‌های دارای دسترسی کامل یا جزئی اصلاح
شد؛ 401 مسیر ورود مجدد دارد، کنترل‌های فرم به label و خطای دسترس‌پذیر متصل‌اند،
ثبت موفق شماره پیگیری نشان می‌دهد و سربرگ تکراری گزارش حذف شد. fixture محلی ۱۲
تیکت Website را تکرارپذیر و مساوی به jahanbastan/nystkt متصل کرد. ۹۰ تست API،
۵۶ تست Web، lint، typecheck و build تولیدی هر دو برنامه موفق‌اند. smoke جداگانه
3101/4001 موفق است. build تأییدشده سپس روی Web3100/API4000 قرار گرفت و صفحه ورود
واقعی تأیید شد؛ بازبینی داخل ماژول منتظر ورود کاربر است. جزئیات در
[سند Task](tasks/CUSTOMER-AFFAIRS-QA-FIXES-0923.md) ثبت شده است.
