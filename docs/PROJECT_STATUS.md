...
## MASTER-005 — خواندن، ثبت و نمایش نتیجه Excel — آماده بررسی
...
- تست جدید سرویس، خواندن Workbook، ایجاد رکورد هتل در مقصد و ثبت Audit را پوشش می‌دهد. ۲۱ تست هدفمند API، ۵ تست Web، lint، typecheck و Build تولیدی هر دو بسته موفق‌اند؛ Schema/Migration و Customer Import تغییر نکرده‌اند.
