...
- نسخه قیمت خرید مرجع، ارز و اعتبار آن؛ طبق `TICKET-PRICING-002` قیمت نهایی فروش، تخفیف، markup و commission متعلق به snapshot قرارداد Sales هستند و قیمت فروش ثابت در Catalog ذخیره نمی‌شود.
