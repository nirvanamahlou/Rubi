...
Nora باید دریافت، پرداخت، فاکتور، تسویه، چک، مانده و سود سفر را با traceability کامل
...
3. حسابداری قانونی کامل در Nora؛ خارج از شناخت و Scope فعلی.

## Final decision

گزینه ۲ نهایی و پذیرفته شد:

- Nora مالک Sub-ledger عملیاتی و دفتر دوطرفه داخلی CRM است.
...
این انتخاب کنترل دوطرفه و گزارش معتبر عملیاتی را فراهم و هم‌زمان از تبدیل Nora به ERP
