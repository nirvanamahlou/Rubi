...
- خروجی همه رکوردهای فیلترشده (نه فقط صفحه جاری) با فرمت واقعی XLSX و بدون اطلاعات تماس؛ ورود گروهی XLSX با قالب دانلودی که فقط ستون «نام مشتری» را اجباری می‌کند.
