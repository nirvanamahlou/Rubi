...
- در فرم ایجاد، هر همراه می‌تواند مسافر جدید یا یک مشتری موجود باشد؛ انتخاب مشتری موجود اطلاعات را تکرار نمی‌کند و Backend در همان تراکنش نقش مسافر و رابطه همراه را با Branch Scope و Audit ثبت می‌کند.
