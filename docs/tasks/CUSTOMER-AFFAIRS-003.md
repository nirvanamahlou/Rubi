...
- Browser preview on `http://127.0.0.1:3102/customer-affairs` reaches the normal login page. Authenticated visual QA is pending user sign-in; no login or permission bypass was introduced.
