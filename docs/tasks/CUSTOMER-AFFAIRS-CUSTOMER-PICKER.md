...
- Labels use «مشتریان و مسافران»; internal contract/version jargon removed. Unique accessible IDs and busy-state selection guards retained. Rubi shared controls preserved under senior-frontend guidance.
