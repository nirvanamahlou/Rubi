...
Frontend assumptions/targets retained: authenticated desktop/corporate, responsive mobile, Rubi/Next unchanged; WCAG AA owner PC-B; p75 LCP2500ms/INP200ms/CLS0.1, JS200KB initial+80KB route gzip, Lighthouse a11y90/perf80 are targets, not measured claims.
