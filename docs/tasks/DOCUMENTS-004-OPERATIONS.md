...
- DatePicker مشترک فرم‌های اسناد Dropdown ماه/سال را حذف می‌کند؛ ماه‌ها در شبکه ۱۲تایی و سال‌ها در شبکه ۱۲تایی صفحه‌بندی‌شده انتخاب می‌شوند و ظاهر آبی Nora، انتخاب شمسی/میلادی و خروجی Gregorian ISO حفظ می‌شود.
