...
## پیگیری روش پرداخت — 2026-09-12

- هر ردیف پرداخت جزئی یک روش مستقل و اجباری دارد: حواله بانکی، چک، نقد، کارت‌خوان
  (POS)، کارت‌به‌کارت، برداشت مستقیم یا سایر. بنابراین پرداخت ترکیبی یک قرارداد می‌تواند
  روش‌های متفاوت داشته باشد.
- انتخاب «چک» عنوان فیلد مرجع را به «شماره چک» تغییر می‌دهد و مقدار آن را اجباری می‌کند؛
  در سایر روش‌ها شماره پیگیری/مرجع اختیاری باقی می‌ماند.
- ۳۴ تست هدفمند Web، typecheck، lint محدود و Production Build با ۴۱ مسیر موفق‌اند.
