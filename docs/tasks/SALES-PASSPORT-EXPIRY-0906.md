...
- Operational activation: retained fresh backup `tmp/nora-before-passport-expiry-live-0906.dump` (670545 bytes), applied only `20260906160000_customer_passport_expiry`, verified unchanged counts/checksums, restarted Web3100/API4000 with the existing document key and CORS settings. Login/new bundle/API health 200, unauthenticated contract 307 and Customers API 401.
