...
Private rehearsal backup: tmp/nora-tour-before-rehearsal-0908.dump. Isolated databases nora_tour_empty_0908 and nora_tour_restore_0908 preserved. Empty43 migrations and seed twice passed; restored-copy upgrade preserved existing business counts/checksums. Fresh live backup tmp/nora-tour-before-live-0908.dump preceded the single additive migration on local nora. No historical migration rewrite, live seed, IAM grant or business-record creation. Known older migration checksum provenance differences were preserved, not reset or hidden.
