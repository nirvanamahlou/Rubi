...
export const PERMISSION_SEED_DATA = [
  ...
  ['marketing.read', 'marketing', 'مشاهده مرکز مارکتینگ'],
  ['marketing.process.read', 'marketing', 'مشاهده فرایند یکپارچه مارکتینگ'],
  ['marketing.campaign.create', 'marketing', 'ایجاد کمپین مارکتینگ'],
  ['marketing.campaign.update', 'marketing', 'ویرایش کمپین مارکتینگ'],
  ['marketing.campaign.approve', 'marketing', 'تأیید کمپین مارکتینگ'],
  ['marketing.campaign.schedule', 'marketing', 'زمان‌بندی کمپین مارکتینگ'],
  ['marketing.campaign.execute', 'marketing', 'اجرای کمپین مارکتینگ'],
  ['marketing.campaign.pause', 'marketing', 'توقف کمپین مارکتینگ'],
  ...
  ['marketing.cost.record', 'marketing', 'ثبت مرجع هزینه کمپین'],
  ['marketing.attribution.read', 'marketing', 'مشاهده انتساب کمپین'],
  ['marketing.analytics.read', 'marketing', 'مشاهده تحلیل عملکرد مارکتینگ'],
  ['marketing.audit.read', 'marketing', 'مشاهده تاریخچه مارکتینگ'],
  [
    'marketing.sensitive_summary.read',
    'marketing',
    'مشاهده خلاصه حساس مارکتینگ',
  ],
  ...
  ['package_pricing.read', 'package_pricing', 'مشاهده پکیج‌ها و قیمت منتشرشده'],
  ['package_pricing.create', 'package_pricing', 'ایجاد پکیج فروش'],
  ['package_pricing.update', 'package_pricing', 'ویرایش پیش‌نویس پکیج'],
  ['package_pricing.archive', 'package_pricing', 'آرشیو نرم پکیج'],
  [
    'package_pricing.period.manage',
    'package_pricing',
    'مدیریت بازه‌های قیمت‌گذاری',
  ],
  ['package_pricing.rule.manage', 'package_pricing', 'مدیریت قواعد قیمت'],
  ['package_pricing.cost.read', 'package_pricing', 'مشاهده هزینه پایه پکیج'],
  ['package_pricing.margin.read', 'package_pricing', 'مشاهده سود پکیج'],
  ['package_pricing.publish', 'package_pricing', 'تأیید و انتشار مستقل قیمت'],
  ['package_pricing.stop', 'package_pricing', 'توقف فروش پکیج'],
  [
    'package_pricing.discount.override',
    'package_pricing',
    'عبور مجاز از تخفیف استاندارد فروش',
  ],
  ['package_pricing.quote.create', 'package_pricing', 'ایجاد پیشنهاد قیمت'],
  [
    'package_pricing.template.manage',
    'package_pricing',
    'مدیریت قالب نسخه‌دار بنر',
  ],
  ['package_pricing.render', 'package_pricing', 'درخواست خروجی بنر یا PDF'],
  ['package_pricing.audit.read', 'package_pricing', 'مشاهده Audit قیمت و پکیج'],
